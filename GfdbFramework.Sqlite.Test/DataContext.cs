...
using GfdbFramework.Sqlite.Test.Entities;
...
namespace GfdbFramework.Sqlite.Test
{
    ...
    /// 数据操作上下文对象类。
    /// </summary>
    public class DataContext : Sqlite.DataContext
    {
        ...
        /// </summary>
        public DataContext()
            : base("3.2.9", $"Data Source={Path.Combine(Path.GetDirectoryName(typeof(DataContext).Assembly.Location), "Databases\\TestDB.db")};Version=3")
        {
